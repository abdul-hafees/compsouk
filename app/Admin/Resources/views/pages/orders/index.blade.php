    ...
    <h1 class="page-title">Orders</h1>
        <div class="page-header-actions">
            ...
            <a class="btn btn-sm btn-secondary" href="#"
               data-toggle='modal' data-target='#excel-modal'>
...
@section('content')
    ...
    <div class="modal fade" id="excel-modal" tabindex="-1" role="dialog" aria-labelledby="excel-modalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="excel-modalLabel">Import Orders</h5>
                    <button type="button" class="btn-close text-dark" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form id="excel-form" method="POST" action="{{ route('admin.orders.import-excel') }}" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input id="excel" name="excel" type="file" required
                                       ...
                                       placeholder="Order date" value="{{ old('excel') }}" autocomplete="off">
                                @error('excel')
                                <span class="invalid-feedback" role="alert">{{ $message }}</span>
                                @enderror

                                <a href="{{ asset('assets/imports/orders.xlsx') }}" target="_blank">Download Sample Excel File</a>
                            </div>
                        </div>
