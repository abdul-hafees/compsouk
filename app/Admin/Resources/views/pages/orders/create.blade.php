...
@section('content')
    <div class="panel">
        <form class="confirm" id="form-order-create" method="POST" action="{{ route('admin.orders.store') }}">
            @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input id="reference_number" name="reference_number" type="text"
                                       ...
                                       placeholder="Reference Number" value="{{ old('reference_number') }}" autocomplete="off">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input id="order_date" name="order_date" type="date"
                                       ...
                                       placeholder="Order date" value="{{ old('order_date') }}" autocomplete="off">
                                @error('order_date')
                                <span class="invalid-feedback" role="alert">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input id="total_amount" name="total_amount" type="text"
                                       ...
                                       placeholder="Total amount" value="{{ old('total_amount') }}" autocomplete="off">
                                @error('total_amount')
                                <span class="invalid-feedback" role="alert">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-9">
                                <select id="payment_method" name="payment_method"
                                    ...
                                    @foreach($paymentMethods as $key => $method)
                                        <option
                                            value="{{ $key }}" {{ old('payment_method') == $key ? 'selected' : '' }}>
                                            {{ $method }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <textarea id="billing_address" name="billing_address"
                                          ...
                                          placeholder="Enter billing address" rows="4">{{ old('billing_address') }}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <textarea id="shipping_address" name="shipping_address"
                                          ...
                                          placeholder="Enter billing address" rows="4">{{ old('shipping_address') }}</textarea>
